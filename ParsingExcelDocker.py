...
credentials = pika.PlainCredentials(username='parser', password='parser')
connection = pika.BlockingConnection(pika.ConnectionParameters(host='54.144.236.23', port='5672', credentials=credentials))
